...
<?php 
    if(isset($id_product)){
        ...
        $sql = "select * from product where product_id = " .$id_product;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    <h5>Instock: <?php echo $row['state']?></h5>
                                    <h4><?php echo '<td>' . number_format($row['product_price'], 0, '.', '.') . 'VND</td>';?><span></span></h4>
                                </div>
                                <div class="product-list">
<?php 
 echo '<td><a href="/doantichhop/ShopPet/add-to-cart.php?id='.$row["product_id"].'"> Add Product</a></td>';
?>
                                    ...
                                    <div class="specification-table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-price"><?php echo '<td>' . number_format($row['product_price'], 0, '.', '.') . 'VND</td>';?></div>
                                                </td>
                                            </tr>
                                            <!-- <tr>
