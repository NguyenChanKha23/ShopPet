        ...
        <div class="nav-item">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li onclick="getname(this)" name="home" id="nav-home" ><a href="./admin.php">Danh mục</a></li>
                        <li onclick="getname(this)" name="shop" id="nav-shop"><a href="./acountmanager.php">Quản lý tài khoản</a></li>
                        ...
                        <li onclick="getname(this)"><a href="./odermanager.php">Quản lý đặt hàng</a></li>
                        <li onclick="getname(this)"><a href="./comment.php">Quản lý đánh giá</a></li>
                        <!-- <li onclick="getname(this)"><a href="#"></a>
                            <ul class="dropdown">
