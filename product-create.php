...
<?php 
    if(isset($_POST['product_name'])) {
        ...
        $sql = "insert into product(product_name,product_desc,category_id,product_price,product_image) value ('".$product_name."','".$product_desc."','".$category_id."','".$product_price."','".$target_file."')";
        echo $sql;
        ...
        <div class="card-body">
            ...
            <div class="basic-form">
                <form action="product-create.php" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label" style="white-space: normal;">Product Price</label>
                        <div class="col-sm-10">
                            <input type="text" name="product_price" class="form-control input-rounded" placeholder="">
                        </div>
                    </div>
                    <div class="form-group row">
