...
<?php
    if(isset($_POST['submit'])){
        foreach($_POST['qty'] as $key=>$value) {
            ...
            echo "<script>console.log('Debug Objects: " . $value . " === ".$key. "' );</script>";
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr id="product_<?php echo $row['product_id']?>">
                                    ...
                                    <td class="p-price first-row"><?php echo '<td>' . number_format($row['product_price'], 0, '.', '.') . 'VND</td>';?></td>
                                    ...
                                    <?php 
                                        ...
                                        $total += $subtotal;
                                    ?>
                                    <td class="total-price responseData_<?php echo $row['product_id']?> first-row"> <?php echo '<td>' . number_format($row['product_price'], 0, '.', '.') . 'VND</td>'; $subtotal;?></td>
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    ...
                                    <li class="cart-total">Total <span class="subtotal-ajax"><?php echo $total?>đ</span></li>
                                </ul>
